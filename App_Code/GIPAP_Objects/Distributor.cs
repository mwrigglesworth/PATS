...
namespace GIPAP_Objects
{
    public class Distributor
    {
        ...
        //**************************************************************************************************************
        public Distributor(int currid)
        {
            DataSet myData;
            SqlParameter CurrID = new SqlParameter("@DistributorID", SqlDbType.Int);
            CurrID.Value = currid;

            myData = SqlHelper.ExecuteDataset(connString, CommandType.StoredProcedure, "spr_GetDistributorProfile", CurrID);
        ...
        public void Create(string createdby)
        {
            ...
            SqlHelper.ExecuteNonQuery(connString, CommandType.StoredProcedure, "spr_CreateDistributor", arrParams);

            this.DistributorID = (int)arrParams[1].Value;
        }
        //**********************************************************************************************************************
        public void Update(string modifiedby)
        {
            ...
            arrParams[1] = new SqlParameter("@DistributorID", SqlDbType.Int);
            arrParams[1].Value = this.DistributorID;
            ...
            //Send the data to the database
            SqlHelper.ExecuteNonQuery(connString, CommandType.StoredProcedure, "spr_UpdateDistributor", arrParams);
        }
        //**********************************************************************************************************************
        public void Approve(string modifiedby)
        {
            ...
            arrParams[0] = new SqlParameter("@DistributorID", SqlDbType.Int);
            arrParams[0].Value = this.DistributorID;

            arrParams[1] = new SqlParameter("@ModifiedBy", SqlDbType.NVarChar, 50);
            arrParams[1].Value = modifiedby;

            //Send the data to the database
            SqlHelper.ExecuteNonQuery(connString, CommandType.StoredProcedure, "spr_ApproveDistributor", arrParams);
        }
        //**********************************************************************************************************************
        public void UnApprove(string modifiedby)
        {
            ...
            //Send the data to the database
            SqlHelper.ExecuteNonQuery(connString, CommandType.StoredProcedure, "spr_UnApproveDistributor", arrParams);
        }
        //**********************************************************************************************************************
        public string DistributorHeader()
        {
        ...
        public string DistributorInfo()
        {
            ...
            cInfo.Append("<font class='lbl'>Country: </font><a href=\"../Country/CountryInfo.aspx?choice=" + this.CountryID + "\">" + this.CountryName + "</a><br>");
        ...
        //**********************************************************************************************************************
        public DataSet DistributorSearch()
        {
            DataSet ds = new DataSet();
            StringBuilder strSQL = new StringBuilder();
            strSQL.Append("Select '<a href=DistributorInfo.aspx?choice=' + Convert(nvarchar, Distributorid) + '>' + OfficeName + '</a>' as Distributor");
            strSQL.Append(", City, Replace(Replace(Replace(Approved, 0, 'No'), 1, 'Yes'), 2, 'Pending') as '<b>Approved</b>' from tblDistributor where ");
        ...
        private void Inflate(DataSet ds)
        {
            ...
            this.DistributorID = Convert.ToInt32(ds.Tables[0].Rows[0]["DistributorID"]);
