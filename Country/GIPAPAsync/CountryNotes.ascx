<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CountryNotes.ascx.cs" Inherits="Country_GIPAPAsync_CountryNotes" %>
<div class="MainColDivHeader">Country Notes</div><div class="MainColDivHeaderRight"></div>
