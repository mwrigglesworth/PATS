<%@ Page Language="C#" MasterPageFile="~/PATS.master" AutoEventWireup="true" CodeFile="FESearch.aspx.cs" Inherits="FinancialEvaluator_FESearch" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:100%; clear:both; text-align: left;">
<h1>NOA Financial Evaluator Search</h1>
<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="900" align="center" border="0">
	<TR>
		<TD> Name:</TD>
		<TD>
			<asp:textbox id="txtName" tabIndex="1" Width="200px" runat="server"></asp:textbox></TD>
		<TD>City:</TD>
		<TD>
			<asp:textbox id="txtCity" tabIndex="4" Width="200px" runat="server"></asp:textbox></TD>
	</TR>
	<TR>
		<TD>Phone:</TD>
		<TD>
			<asp:textbox id="txtPhone" tabIndex="8" Width="200px" runat="server" DESIGNTIMEDRAGDROP="574"></asp:textbox></TD>
		<TD>Country:</TD>
		<TD>
	...
	<TR>
		<TD>Fax:</TD>
		<TD>
			<asp:textbox id="txtFax" tabIndex="9" Width="200px" runat="server"></asp:textbox></TD>
		<TD></TD>
		<TD></TD>
	</TR>
	<TR>
		<TD>Email:</TD>
		<TD>
			<asp:textbox id="txtEmail" tabIndex="10" Width="200px" runat="server"></asp:textbox></TD>
		<TD>Approved:</TD>
		<TD>
	...
	<TR>
		<TD colSpan="4"><STRONG><FONT color="green">Administrator&nbsp;Information</FONT></STRONG></TD>
	</TR>
	<TR>
		<TD>First Name:</TD>
		<TD>
...
<br />
<asp:Label id="LabelResultCount" runat="server" ForeColor="green" Font-Bold="True"></asp:Label><br />
