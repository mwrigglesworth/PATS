<%@ Page Title="" Language="C#" MasterPageFile="~/PATS.master" AutoEventWireup="true" CodeFile="AddStockist.aspx.cs" Inherits="Stockist_AddStockist" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:100%; clear:both; text-align: left;">
<h1>Add NOA Stockist</h1>
		...
		<TR>
			...
			<tr><td></td><td></td><td>Mobile:</td><td>
					<asp:textbox id="txtAdminMobile" tabIndex="15" runat="server" Width="200px" 
                        ...
                        <tr><td></td><td>
                            <asp:Button ID="ButtonSave" runat="server" Text="Add NOA Stockist" 
