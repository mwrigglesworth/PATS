<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubRegionNotes.ascx.cs" Inherits="SubRegion_GIPAPAsync_SubRegionNotes" %>
<div class="MainColDivHeader">SubRegion Notes</div><div class="MainColDivHeaderRight"></div>
