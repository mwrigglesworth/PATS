...
public partial class Patient_GIPAPAsync_PatInfo : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LabelHeader.Text = myPatient.PatientInfo(choice, sessUse);
        LabelAddy.Text = myPatient.AddressInfo(sessUse.Role);
    }
}
