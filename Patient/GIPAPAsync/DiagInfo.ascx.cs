...
public partial class Patient_GIPAPAsync_DiagInfo : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LabelDiag.Text = myPatient.DiagnosisInfoTable(choice,0);
        LabelDose.Text = myPatient.FinancialInfoTable(sessUse.Role);
    }
}
