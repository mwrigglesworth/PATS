<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegionNotes.ascx.cs" Inherits="Region_GIPAPAsync_RegionNotes" %>
<div class="MainColDivHeader">Region Notes</div><div class="MainColDivHeaderRight"></div>
