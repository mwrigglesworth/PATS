<%@ Page Language="C#" MasterPageFile="~/PATS.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="MaxStation_Dashboard" %>
...
<div id="LeftCol">
        ...
        <div class="LeftColSpacer">
            <asp:HyperLink ID="hlGIPAP" runat="server" ForeColor="SteelBlue">GIPAP-NOA</asp:HyperLink>
&nbsp;
        <asp:HyperLink ID="hlPINC" runat="server" ForeColor="DeepPink" NavigateUrl="../GIPAPTrusted.aspx?reqform=home">PINC</asp:HyperLink>
&nbsp;
        <asp:HyperLink ID="hlMYPAP" runat="server" ForeColor="DarkOrange">MYPAP</asp:HyperLink>
&nbsp;
        <asp:HyperLink ID="hlTIPAP" runat="server" ForeColor="PURPLE">TIPAP</asp:HyperLink>
        </div>
    ...
    <div style="width: 100%; font-size: 14pt; text-align: left;">
        ...
        <div class="MainColDiv"><cc1:partialupdatepanel ID="PartialUpdatePanelQueues" 
                runat="server" UserControlPath="MaxStation/UserQueues.ascx">
			<Parameters><cc1:Parameter Name="MyParameter" Value="Hello world" />
                            </Parameters>
    <LoadingTemplate>
