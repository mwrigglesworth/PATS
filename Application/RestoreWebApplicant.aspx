<%@ Page Title="" Language="C#" MasterPageFile="~/PATS.master" AutoEventWireup="true" CodeFile="RestoreWebApplicant.aspx.cs" Inherits="Application_RestoreWebApplicant" %>
...
<%--		<tr><td></td>
        <td align="right">
					<asp:linkbutton id="lbExistingPatients" runat="server" Visible="False" ForeColor="Red" CausesValidation="False" onclick="lbExistingPatients_Click">Patients Exist with a Similar Name</asp:linkbutton>
        </td></tr>
--%>
		<tr>
        <td><STRONG>Country:</strong>&nbsp;
							...
							<asp:DropDownList id="dropCountry" runat="server" Width="200px" Visible="false"></asp:DropDownList>
...
--%>							<asp:dropdownlist id="dropPhysician" runat="server" Width="200px" Visible="false"></asp:dropdownlist>
                            <asp:Label id="LabelPhysician" runat="server"></asp:Label>
                            <br />
                        ...
                        <%if (showDistributor)
                          {%>
							...
							<asp:comparevalidator id="CompareValidator1" runat="server" ErrorMessage="Program Officer" ControlToValidate="dropPO"
								Operator="NotEqual" ValueToCompare="Select a PO">*</asp:comparevalidator>
							<asp:dropdownlist id="dropPO" runat="server" Width="200px"></asp:dropdownlist></td>--%>
		...
		<%--<tr><td>Delete Reason:&nbsp;
			...
			<tr><td align="center">
				    ...
				    <asp:Button ID="ButtonRestore" runat="server" BackColor="Lime" ForeColor="Green" 
                        Text="Restore Applicant" 
                        CausesValidation="False" onclick="ButtonRestore_Click" /><br />
