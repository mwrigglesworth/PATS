<%@ Page Language="C#" MasterPageFile="~/PATS.master" AutoEventWireup="true" CodeFile="AddClinic.aspx.cs" Inherits="Clinic_AddClinic" %>
...
<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="900" align="left" border="0">
    ...
    <TABLE id="Table3" cellSpacing="1" cellPadding="1" width="900" align="center" border="0">
		...
		<TR>
			...
			<tr><td></td><td>
                            <asp:Button ID="ButtonSave" runat="server" Text="Add Clinic" 
